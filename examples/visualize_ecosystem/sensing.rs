use super::{Vec2, VISION_RAYS, VISION_ANGLE_DEG, VISION_RANGE, FOOD_RADIUS, FOOD_VECTOR_MAX_RANGE, DANGER_VECTOR_MAX_RANGE, DENSITY_SECTORS, DENSITY_RADIUS, INPUTS, WORLD_W, WORLD_H};
